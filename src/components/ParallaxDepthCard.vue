...
@Component({
  name: "ParallaxDepthCard"
})
export default class ParallaxDepthCard extends Vue {
  width = 0;
  height = 0;
  mouseX = 0;
  mouseY = 0;
  ...
  handleMouseMove(e: MouseEvent) {
    const card = this.$refs.card as HTMLElement;
    this.mouseX = e.pageX - card.offsetLeft - this.width / 2;
    this.mouseY = e.pageY - card.offsetTop - this.height / 2;
  }
